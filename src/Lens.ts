...
import { flow, Predicate, Refinement, pipe } from 'fp-ts/function'
import { Functor, Functor1, Functor2, Functor3 } from 'fp-ts/Functor'
...
declare module 'fp-ts/HKT' {
  interface URItoKind2<E, A> {
    readonly 'monocle-ts/Lens': Lens<E, A>
  }
}
